...
# connects/pegs the shared LDK gateway. Follow docs/devimint-runbook.md §1 to export
# FEDIMINT_WORKTREE, then REBUILD wallet-cli into this repo's target-nix BEFORE running:
#   set -euo pipefail
