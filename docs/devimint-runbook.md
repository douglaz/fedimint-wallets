...
The field's contract is `API-12`/`API-33` in [`04-api-contract.md`](https://github.com/douglaz/fedimint-wallets-spec/blob/main/04-api-contract.md) in the specification repository (semantics in
`OPS-31`); this is the
