...
pub use runtime::{
    ...
    recover_intent_key, DirectInflowOutcome, FinalizeOutcome, MoveOutcome, ProbeOutcome,
    ProbeReport, ReconcileSummary, Runtime, WatchCycleReport, WatchDiscoverOutcome,
